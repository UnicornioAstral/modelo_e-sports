...
const buitres = new Equipo( 'Los Buitres'. fifa, 110 );
        ...
        helena.obtenerTrofeo( trofeoFairPlay, new Date('20-08-2026'));
...
console.log( '=== EQUIPO ===');
console.log(buitres.nombre, '| Juego:', buitres.juego.nombre);
console.log('Nivel (puntos por jugadores):', buitres.calcularNivel());
console.log('Trofeos equipo:', buitres.trofeos.length);

console.log( '=== JUGADORES ===');
buitres.listarAtletas().forEach( a => {
  console.log(`${a.nombreCompleto} — Exp: ${a.experiencia} pts — Trofeos: ${a.trofeos.length}`);
});

console.log( '=== SESION ===');
console.log('Estado:', sesion.estado);
console.log('Horas:', sesion.calcularHoras());
console.log('Puntos asignados:', puntos);

console.log( '=== HARDWARE ===');
console.log('Consola:', consola1.nombre, '| IP:', consola1.ip);
console.log('Control:', control1.tipo, '| Plataforma:', control1.plataforma.nombre);


    const sesion2 = new SesionEntrenamiento('2026-08-16', '11:00', '12:00', fifa, arbitro);
        sesion2.cancelar();
        console.log('\n=== SESIÓN 2 ===');
        console.log('Estado:', sesion2.estado);
